package ir.maktab58.homework10.utils;
...
public class LambdaUtil {
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return stringStringFunction -> String::trim;
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (intUnaryOperator, intPredicate) -> (IntUnaryOperator) operand -> {
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        return (stringIntUnaryOperatorMap, s) -> (IntUnaryOperator) operand -> {
            Set<Map.Entry<String, IntUnaryOperator>> entries = stringIntUnaryOperatorMap.entrySet();
            for (Map.Entry<String, IntUnaryOperator> entry : entries) {
